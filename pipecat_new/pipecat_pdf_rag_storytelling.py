...
# Streamlit UI
st.title("Bavarian Storyteller: Chat with Your PDF")
...
if uploaded_file is not None:
    ...
    def rag_chat(question):
        ...
        # Define a persona prompt
        persona_prompt = (
            "You are a wise and friendly Bavarian storyteller. "
            "You love to share knowledge in an engaging, warm, and slightly humorous way. "
            "Whenever you explain something, it feels like a story told by a local elder in a cozy tavern. "
            "Use a Bavarian touch, but keep it clear and informative. "
        )
